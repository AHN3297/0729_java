...
public class Casting {
	 ...
	 * ===========매우중요=============
	 * 
	 * 과정 끝날때까지 까먹으면 큰일나는 거
	 * 자바에서 값을 처리하는 규칙
	 * 
	 * 1. =(대입 연산자)를 기준으로 왼쪽 / 오른쪽이 같은 자료형이어야 한다.
	 * => 같은 자료형에 해당하는리터럴값만 대입할 수 있다.
	 * => 자료형이 다를 경우 == 값을 바꿔서 대입해야 함.
	 * 
	 * 2. 같은 자료형들끼리만 연산이 가능함
	 * => 자료형이 다른데 연산이 하고 싶다? 두 중에 하나를 "형변환"해서 나머지하나와 동일하게 맞춤
	 * 
	...
	public void autoCasting() {
		...
		// 정수가 실수로 면환될 때 큰사이즈의 정수타입이 작은 사이즈 실수 타입으로 형변환
		// 4Byte float형이 long형보다 표현할 수 있는 값의 범위가 더 넓기 때문
		
		//1 2 3
		//1.0000001 1.00000002 1.00000003
