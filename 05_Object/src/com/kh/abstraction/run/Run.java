package com.kh.abstraction.run;

import com.kh.abstraction.vo.Puppy;

public class Run {
	public static void main(String[] args) {
		/*
		 * 객체 지향 프로그래밍 :	현실세계에서의 독립적인 존재(개체)를 속성과 행위를 가진 객체로 만들어서
		 * 					  	객체간의 상호작용을 통해 프로그래밍 하는기법
		 * 
		 ...
		 * 
		 * 오늘의 숙제
		 * 현실세계에 존재하는 나만의 그 무언가를 찾아서 VO클래스를 만들고
		 * PuppyCareRun클래스를 참고하여 생성한 객체를 관리할 수 있는 프로그램을 작성하시오.
		 * 개수 ) VO클래스 5개 + VO 관리프로그램 5개
		 * 각VO클래스의 최소 필드 수 5개
		 * 최소 한 개 이상의 필드 값으 변경할 수 있는 메소드 생성 --> Puppy클래스의 bark()처럼
		 * 제출할 곳 : 우리반 게시판 게시글 작성
		 * 				과제탭을 선택할 수 있음
		 * 제한시간 : 2025 / 08 / 07 / 07:59까지
		 * 게시글 제목 : 홍제동 VO클래스 만들기
		 * 
		 * +메모리구조 그리기
		 * 
		 * 
		...
		smart.sniff();
		soldier.sniff();
		System.out.println("짖기전 상든이 몸무게 : ");
