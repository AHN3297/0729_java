...
public class StringController {
	...
	public void method1() {
		...
		// 실제 담겨져있는 문자열 리터럴 value란 값을 반환하겠음 오버라이딩
		...
		//주소값을 해싱하는 것이 아니라 질게 담긴 문자열 값을 기반으로
		// 해시코드 값을 만들도록 오버라이딩
		
		//진짜 저 참조형 변수들을 식별할 수 있는 값을 알아내는법
		//System.identityHashCoid()참조변현수)
	...
	public void method4() {
		...
		// StringBuffer
		// Buffer == 임시저장공간
		// 문자열은 불변객체라서 내용물이 변결될 때 마다 새로운 공간을 할당해서 집어넣는다.
		// 임시 공간에 차곡차곡 담았다가 한번에 처리해주는 클래스
	...
	public void StringMethod() {
		String str1 = "경실련하이텔 아카데이";
		// 1. answkduf.length() :int
		// 문자열의 길이를반환;
		...
		//3. 문자열.sybstrint(int beginindex) : String
	...
	// 6. 문자열.replace(char o;d, char new) : String
	...
	//   문자열.toLowerCase() : String -> 싹다 th문자로 바꾸기
	...
	public void split() {
		...
		*/
		...
		while(stn.hasMoreTokens()) {
			//남아있는토큰이 있다면 true / 토큰 다뽑혔다면 false
			System.out.println(stn.nextToken());
		}
	}
