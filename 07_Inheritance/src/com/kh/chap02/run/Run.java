...
public class Run {
	public static void main(String[] args) {
		...
		// 호출을 하는 메소드가 해달 클래스에 존재하니 않는다면
		// 자동으로 해당 클래스의 부모클래스에 있는 메소드를 호출
		
		ItalyFood yf = new ItalyFood("기름파스타", "기름", 10, 5);
		...
		// 자식클래스에 존재하는 메소드가 우선권을 가져서 호출됨 <*중요*>
		 ...
		 * 
		 * => Object클래스에 있는멤버를 사용할 수 있음
		 * => Object클래스에 이쓴ㄴ 메소드가 마음에 안든다면 재정의를 할 수있음
		 */
	}
