...
public class run {
	public static void main(String[] args) {
		...
		SimpleCal minuse = new SimpleCal() {
			@Override
			public int cal(int a, int b) {
				return a - b;
			}
		...
		System.out.println("5 - 3 = " + minuse.cal(5,  3));
		
		SimpleCal adder2 = (a, b) -> a + b;
		SimpleCal minuse2  = (a, b) -> a - b;
		System.out.println("2 + 4 = " + adder2.cal(2,  4));
		System.out.println("2 - 4 = " + minuse2.cal(2,  4));
