package com.kh.first; // 패키지 선언부 : 현재클래스의 위치

	/*
	 * 이	주석 (Comments)
	 * 게	주석은 프로그램을 실행하는데 있어 아무런 영향을 끼치지 않음ㅇㅇ
	 * 다	코드를 작성한 후 코드를 이해하기 쉽도록 하기 위함
	 * 주	주석을 달아놓으면 유지보수 시간 단축 가능
	 * 석	소스코드는 사람이 보기 좋게 작성
	 * 		주석의 종류(3가지 / 오늘은 2개만)
	 * 		1. 한 줄 주석(//) : 주석 내용이 한 줄 일때 사용
	 * 		"//"이후부터 행의 끝까지 모든 내용을 주석으로 간주
	 * 
	 * 		2. 여러 줄 주석("/* ~~~~ *")여러 줄의 주석이 필요 할 때 사용
	 * 		"~~~~" 사이의 모든 내용이 주석으로 간주
	 * 
	 */
...
public class FirstClass { // 클래스 이름을 FrstClass라고 지었음 { Scope }
	
	// Scope(블록){   } 은 중괄호로 묶은 부분을 이야기하며, 복합문을 구성하는 요소이다
	// 즉, 종속된 문장이 다수 개일 때 '{'로 시작하고'}'로 닫는다.
	...
	public static void main(String[] args) {
		...
		// 메소드안의 구문을 수행하고 싶다면 반드시 "호출"해야 한다
	...
	public static void printMyName() {
		System.out.print("안녕하세요 제 이름은 안예성입니다. 반갑습니다~");
